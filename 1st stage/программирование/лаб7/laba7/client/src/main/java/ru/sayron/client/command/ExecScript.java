...
import ru.sayron.client.utility.ProcessingCode;
...
public class ExecScript {
    ...
    public ExecScript(Scanner userScanner, String script) {
            ...
            do {
                try {
                    ...
                    if (fileMode()) {
                        ...
                        Outputer.print(Main.PS1);
                        userInput = "execute_script";
                    }
                    userCommand = (userInput.trim() + " ").split(" ", 2);
                    userCommand[1] = userCommand[1].trim();
                    if (script != null && userInput.equals("execute_script")) {
                        userCommand[1] = script.trim();
                    }
