...
import com.brigada.is.exception.ConstraintViolationException;
...
public class MusicBandService {
    ...
    public MusicBandResponseDTO createMusicBand(MusicBandRequestDTO musicBandRequestDTO, Long studioId, String username) {
        ...
        checkUniqueConstraint(musicBandRequestDTO);
        ...
        checkUniqueConstraint(musicBandRequestDTO);
        MusicBand saved = musicBandRepository.save(entity);

        return MusicBandMapper.INSTANCE.toResponseDTO(saved);
    }
    ...
    public MusicBandResponseDTO updateMusicBand(MusicBandRequestDTO musicBandRequestDTO, Long id, Long studioId, String username) {
        ...
        if (!existingEntity.getName().equals(musicBandRequestDTO.getName())) checkUniqueConstraint(musicBandRequestDTO);
    ...
    private void checkUniqueConstraint(MusicBandRequestDTO requestDTO) {
        if (musicBandRepository.existsByName(requestDTO.getName())) throw new ConstraintViolationException("Name must be unique");
    }
}
